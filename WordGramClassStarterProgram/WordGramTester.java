...
public class WordGramTester {
    ...
    public void testAddShift(){
        ...
        WordGram one = new WordGram(words,0,words.length);
        WordGram two = one.shiftAdd("dupa");
        System.out.println("Size: " + one.length() + "/ " + one.toString());
        System.out.println("Size: " + two.length() + "/ " + two.toString());
    }
